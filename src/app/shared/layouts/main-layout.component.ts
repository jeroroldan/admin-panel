        ...
        <div class="flex h-full flex-col">
          ...
          <nav class="flex-1 px-4 py-6 space-y-1">
            <a routerLink="/dashboard"
               ...
               class="group flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors">
          ...
          <div class="flex-shrink-0 border-t border-gray-700 p-4">
            <div class="flex items-center">
              ...
              <div class="ml-3 flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-400 truncate">{{ getCurrentUser()?.role }}</p>
              </div>
              <button
                (click)="logout()"
                class="ml-2 flex-shrink-0 p-1 text-gray-400 hover:text-gray-300">
...
export class MainLayoutComponent implements OnInit {
  ...
  ngOnInit() {
    // Configure the modal service with the view container
