      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            [class.border-red-300]="customerForm.get('firstName')?.invalid && customerForm.get('firstName')?.touched"
            [class.border-gray-300]="!customerForm.get('firstName')?.invalid || !customerForm.get('firstName')?.touched"
          >
        ...
        <div>
          ...
          <input
            ...
            class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
            [class.border-red-300]="customerForm.get('lastName')?.invalid && customerForm.get('lastName')?.touched"
            [class.border-gray-300]="!customerForm.get('lastName')?.invalid || !customerForm.get('lastName')?.touched"
          >
        ...
        <div>
          ...
          <input
            ...
            class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
            [class.border-red-300]="customerForm.get('email')?.invalid && customerForm.get('email')?.touched"
            [class.border-gray-300]="!customerForm.get('email')?.invalid || !customerForm.get('email')?.touched"
          >
...
export class CustomerFormComponent implements OnInit {
  ...
  private initializeForm() {
    this.customerForm = this.fb.group({
      ...
      ...(this.editMode && { isActive: [this.customer?.isActive ?? true] })
    });
  }
